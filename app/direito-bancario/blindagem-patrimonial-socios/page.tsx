...
export default function BlindagemPatrimonialSociosPage() {
  ...
  const blindagemWA =
    'https://wa.me/5531971746972?text=Ol%C3%A1!%20Sou%20s%C3%B3cio%20%2F%20avalista%20de%20empresa%20e%20preciso%20de%20orienta%C3%A7%C3%A3o%20para%20proteger%20meu%20patrim%C3%B4nio%20pessoal%20contra%20d%C3%ADvidas%20banc%C3%A1rias.'

  const pilaresBlindagem = [
    {
      icon: Home,
      title: 'Proteção de Bem de Família (Lei 8.009/90)',
      desc: 'O imóvel residencial próprio do casal ou da entidade familiar é inalienável e impenhorável por dívidas comerciais, bancárias ou tributárias.',
    },
    {
      icon: Building,
      title: 'Combate à Desconsideração da PJ',
      desc: 'Defesa contra pedidos de invasão do patrimônio pessoal de sócios sem a comprovação estrita de desvio de finalidade ou confusão patrimonial (Art. 50 do Código Civil).',
    },
    {
      icon: UserCheck,
      title: 'Nulidades de Aval e Fiança',
      desc: 'Exame minucioso de garantias prestadas com vício de consentimento, ausência de outorga uxória do cônjuge ou excesso de garantia em CCBs.',
    },
  ]

  const faqs = [
    {
      q: 'O banco pode penhorar minha casa se eu assinei como avalista da empresa?',
      a: 'A regra geral é a impenhorabilidade absoluta do único imóvel residencial familiar. Salvo exceções estritas e comprovadas, a residência da família não pode ser expropriada para pagar dívida da pessoa jurídica.',
    },
    {
      q: 'Como proteger os bens pessoais antes que ocorra a penhora?',
      a: 'A estruturação patrimonial lícita preventiva, com auditoria das garantias prestadas e defesas nas execuções de CCB, impede a constrição de contas e veículos dos sócios.',
    },
    {
      q: 'O cônjuge do sócio também pode ter os bens atingidos?',
      a: 'Não, se a dívida não reverteu em benefício da entidade familiar ou se o cônjuge não assinou formalmente a garantia com outorga uxória. Ingressamos com Embargos de Terceiro para excluir a meação do cônjuge.',
    },
  ]
  ...
  return (
    <>
      ...
      <main className="flex flex-col w-full overflow-x-clip bg-ink text-ivory">
          ...
          >
            <div className="absolute inset-0 w-full h-full pointer-events-none overflow-hidden">
              <Image
                ...
                alt="Blindagem Patrimonial de Sócios e Avalistas"
                fill
                priority
                sizes="100vw"
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
              <div className="lg:col-span-8 xl:col-span-7 mt-[34vh] sm:mt-[40vh] lg:mt-0 relative z-10">
                <div className="inline-flex items-center gap-2 px-3 py-1 bg-forest/40 border border-gold/30 text-gold text-[.6rem] uppercase tracking-widest font-medium mb-4">
                  <Shield className="w-3.5 h-3.5" /> Proteção de Bem de Família &bull; Lei 8.009/90
                </div>
                ...
                >
                  <span className="reveal-line">
                    <span>Blindagem patrimonial de sócios:</span>
                  </span>
                  <span className="reveal-line">
                    <span className="text-champagne font-serif italic font-normal">
                      sua casa e bens pessoais
                    </span>
                  </span>
                  <span className="reveal-line">
                    <span>protegidos de dívidas da empresa.</span>
                  </span>
                </h1>

                <p
                  id="hero-blindagem-desc"
                  className="mt-5 max-w-[55ch] text-ivory/85 leading-relaxed text-sm sm:text-base font-light"
                >
                  Dívidas corporativas e garantias de CCB não podem comprometer o teto da sua família ou o patrimônio construído com anos de trabalho.
                </p>

                <div id="hero-blindagem-cta" className="mt-8 flex flex-col sm:flex-row gap-3.5">
                  <a
                    href={blindagemWA}
                    target="_blank"
                  ...
                  >
                    ...
                    <span>Proteger patrimônio no WhatsApp</span>
        ...
        {/* 3 PILARES DE DEFESA DOS SÓCIOS */}
          ...
          <div className="max-w-[1440px] mx-auto px-4 sm:px-6 md:px-[5vw]">
            <div className="reveal-on-scroll max-w-3xl mb-12">
              ...
              <p className="text-[.58rem] tracking-[.3em] uppercase text-gold font-normal mb-2">
                Defesa do Patrimônio Pessoal
              </p>
              <h2 className="font-light text-2xl sm:text-3xl lg:text-4xl leading-[1.12] text-ivory tracking-tight">
                Como resguardamos os bens dos sócios e cônjuges perante os bancos credores.
              </h2>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
              {pilaresBlindagem.map((item, i) => {
        ...
        <section className="py-12 bg-forest/20 border-b hairline">
          <div className="max-w-[1440px] mx-auto px-4 sm:px-6 md:px-[5vw]">
            <div className="reveal-on-scroll flex flex-col md:flex-row items-start md:items-center justify-between gap-5 p-5 sm:p-6 glass border border-gold/35 shadow-2xl">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-base sm:text-lg font-normal text-ivory">
                    O banco pediu a penhora dos bens particulares do sócio?
                  </h3>
                  <p className="text-xs sm:text-sm text-ivory/80 mt-1 font-light leading-relaxed max-w-2xl">
                    Nossa equipe atua para comprovar a separação patrimonial e cassar penhoras indevidas sobre contas pessoais, imóveis e quotas societárias.
                  </p>
                </div>
              </div>
              <a
              ...
              >
                <span>Falar com Advogado de Sócios</span>
                <ArrowUpRight className="w-3.5 h-3.5" />
              </a>
            </div>
          </div>
        ...
        <section className="py-16 md:py-24 bg-ink border-b hairline">
          <div className="max-w-[1440px] mx-auto px-4 sm:px-6 md:px-[5vw]">
            <div className="reveal-on-scroll max-w-2xl mb-10">
              <p className="text-[.58rem] tracking-[.3em] uppercase text-gold font-normal mb-2">
                Tira-Dúvidas dos Sócios
              </p>
              <h2 className="font-light text-2xl sm:text-3xl lg:text-4xl leading-[1.12] text-ivory tracking-tight">
                Perguntas Frequentes sobre Proteção de Sócios e Avalistas.
              </h2>
            </div>
        ...
        <section className="py-16 md:py-20 bg-forest/30 border-b hairline text-center flex flex-col items-center">
          <div className="max-w-[1440px] mx-auto px-4 sm:px-6 md:px-[5vw] relative z-10 flex flex-col items-center">
            <h2 className="font-light text-2xl sm:text-3xl md:text-4xl text-ivory tracking-tight max-w-2xl text-balance">
              Não permita que as dívidas da empresa destruam seu patrimônio pessoal.
            </h2>
            <p className="mt-4 text-xs sm:text-sm text-ivory/80 max-w-xl font-light leading-relaxed">
              Agende uma consulta sigilosa com os sócios da Braga &amp; Xavier e desenhe uma estratégia sólida de defesa patrimonial.
            </p>
