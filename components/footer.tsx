      ...
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 md:px-[5vw] py-10 md:py-14">
        <div className="reveal-on-scroll grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-8">
          <div className="md:col-span-5">
            ...
            <p className="mt-3 text-xs text-muted leading-relaxed max-w-[40ch] font-light">
              Direito Bancário, reestruturação de dívidas empresariais, Direito Rural e Agronegócio.
              Sede em Montes Claros – MG e atuação em todo o Brasil.
            </p>
          </div>
          ...
          <nav className="md:col-span-2" aria-label="Contato & Legal">
            <p className="text-[.55rem] tracking-[.25em] uppercase text-gold mb-2.5 font-normal">
              Contato &amp; Legal
            </p>
            <ul className="flex flex-col gap-1.5 text-xs font-light">
              <li>
                <button
                  onClick={() => onOpenTriagem('footer')}
                  className="text-left link-underline text-ivory/70 hover:text-ivory transition-colors cursor-pointer"
                >
                  WhatsApp Oficial
                </button>
              </li>
              <li>
                <a
                  ...
                  className="link-underline text-ivory/70 hover:text-ivory transition-colors"
                >
